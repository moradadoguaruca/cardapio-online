...
const categories = [
  ...
  { id: "vitaminas-shakes", nome: { pt: "Vitaminas & Milkshakes", es: "Licuados & Milkshakes" } },
...
const menuData = [
  ...
  // ============ PETISCOS ============
    ...
    descricao: { pt: "Bolinhos de bacalhau crocantes servidos com molho da casa.",
                 es: "Buñuelos de bacalao crocantes servidos con salsa de la casa." },
  ...
  { id: "petiscos-04", categoria: "petiscos",
    ...
    descricao: { pt: "Tirinhas de peixe empanadas servidas com molho da casa e limão.",
                 es: "Tiritas de pescado empanadas servidas con salsa de la casa y limón." },
  ...
  { id: "petiscos-08", categoria: "petiscos",
    ...
    descricao: { pt: "Camarões empanados na farinha panko servidos com molho da casa e limão.",
                 es: "Langostinos rebozados en panko servidos con salsa de la casa y limón." },
  ...
  { id: "petiscos-10", categoria: "petiscos",
    ...
    descricao: { pt: "Mix de camarão a milanesa, isca de peixe, lula a dorê e batata frita servido com molho da casa e limão.",
                 es: "Mix de langostinos rebozados, tiritas de pescado, calamar frito a dorê y papas fritas servido con salsa de la casa y limón." },
    preco: "399,00", imagem: null },
  { id: "petiscos-11", categoria: "petiscos",
    nome: { pt: "Lula à Dorê (450g)" },
    descricao: { pt: "Lula nacional com leve empanado a dorê acompanhada de molho da casa e limão.",
                 es: "Calamar nacional troceado levemente rebozado a dorê acompañado de salsa de la casa y limón." },
    preco: "129,00", imagem: null },
  { id: "petiscos-12", categoria: "petiscos",
    nome: { pt: "Fish & Chips (900g)" },
  ...
  { id: "saladas-02", categoria: "saladas",
    ...
    descricao: { pt: "Mix de folhas verdes com bacon crocante, queijo parmesão e nossa redução especial de balsâmico.",
                 es: "Mix de hojas verdes con bacon crocante, queso parmesano y nuestra reducción especial de balsámico." },
    preco: "45,90", imagem: null },
  { id: "saladas-03", categoria: "saladas",
    nome: { pt: "Salada de Folhas & Salmão" },
  ...
  { id: "massas-01", categoria: "massas-risotos",
    ...
    descricao: { pt: "Fettuccine ao molho sugo com camarões, lula e mariscos, finalizado com ervas frescas.",
                 es: "Fettuccine con salsa de tomate con langostinos, calamar y mariscos, finalizado con hierbas frescas." },
  ...
  { id: "massas-04", categoria: "massas-risotos",
    ...
    descricao: { pt: "Risoto cremoso preparado com camarões e alho-poró, finalizado com tomate cereja e ervas frescas.",
                 es: "Risoto cremoso preparado con langostinos y puerro, finalizado con tomates cherry y hierbas frescas." },
    preco: "99,90", imagem: null },
  ...
  { id: "carnes-ind-01", categoria: "carnes-individual",
    nome: { pt: "Filé Mignon ao Rôti" },
    descricao: { pt: "Filé mignon grelhado ao molho rôti, acompanhado de purê de batata com queijo e crispy de alho-poró.",
                 es: "Medallones de lomo a la plancha con salsa rôti, acompañados de puré de papa con queso y crispy de puerro." },
    preco: "89,90", imagem: null },
  { id: "carnes-ind-02", categoria: "carnes-individual",
    ...
    descricao: { pt: "Filé mignon grelhado ao molho demi-glace, acompanhado de purê de abóbora e farofa cítrica.",
                 es: "Medallones de lomo a la plancha con salsa demi-glace, acompañados de puré de calabaza y farofa cítrica." },
    preco: "89,90", imagem: null },
  ...
  { id: "peixes-comp-01", categoria: "peixes-compartilhar",
    ...
    descricao: { pt: "Filé de pescada-amarela grelhado com camarões e mariscos ao molho de vinho branco, acompanhado de purê de abóbora, arroz de castanhas, batata frita, salada e farofa.",
                 es: "Filet de pescada amarilla a la plancha con langostinos y mariscos en salsa de vino blanco, acompañado de puré de calabaza, arroz de castañas, papas fritas, ensalada y farofa." },
  ...
  { id: "peixes-comp-02", categoria: "peixes-compartilhar",
    ...
    descricao: { pt: "Filé de pescada-amarela grelhado com camarões e lula ao molho sugo, finalizado com salsinha e azeite de ervas, acompanhado de arroz de castanhas, batata frita, salada e farofa.",
                 es: "Filet de pescada amarilla a la plancha con langostinos y calamar en salsa de tomate, finalizado con perejil y aceite de hierbas, acompañado de arroz de castañas, papas fritas, ensalada y farofa." },
  ...
  { id: "peixes-comp-03", categoria: "peixes-compartilhar",
    ...
    descricao: { pt: "Filé de linguado grelhado ao molho camarões, alcaparras e champignon, acompanhado de arroz de castanhas, batata frita, salada e farofa.",
                 es: "Filet de lenguado a la plancha con salsa de langostinos, alcaparras y champiñon, acompañado de arroz de castañas, papas fritas, ensalada y farofa." },
    preco: "199,00", imagem: null },
  { id: "peixes-comp-04", categoria: "peixes-compartilhar",
    ...
    descricao: { pt: "Tradicional moqueca de peixe com leite de coco, azeite de dendê e pimentões, acompanhada de arroz de castanhas, batata frita, salada e farofa.",
                 es: "Tradicional moqueca de pescado con leche de coco, aceite de dendê y pimientos, acompañada de arroz de castañas, papas fritas, ensalada y farofa." },
    preco: "159,00", imagem: null },
  { id: "peixes-comp-05", categoria: "peixes-compartilhar",
    nome: { pt: "Salmão Grelhado" },
    descricao: { pt: "Filé de salmão grelhado ao pesto, servido com legumes grelhadas, arroz de castanhas, batata frita, salada e farofa.",
                 es: "Filet de salmón a la plancha al pesto, servido con verduras salteadas, arroz de castaña, papas fritas, ensalada y farofa." },
    preco: "209,00", imagem: null },
  ...
  { id: "carnes-comp-01", categoria: "carnes-compartilhar",
    ...
    descricao: { pt: "Filé mignon grelhado ao molho poivre, servido com arroz, salada e batata frita.",
                 es: "Medallones de lomo a la plancha con salsa poivre, servidos con arroz, ensalada y papas fritas." },
    preco: "189,00", imagem: null },
  { id: "carnes-comp-02", categoria: "carnes-compartilhar",
    ...
    descricao: { pt: "Filé mignon grelhado, acompanhado de arroz, feijão, batata frita, salada e farofa.",
                 es: "Medallones de lomo a la plancha, acompañados de arroz, porotos, papas fritas ensalada y farofa." },
    preco: "189,00", imagem: null },
  { id: "carnes-comp-03", categoria: "carnes-compartilhar",
    ...
    descricao: { pt: "Filé de alcatra empanado, coberto com molho de tomate e queijo mussarela, acompanhado de arroz, salada e batata frita.",
                 es: "Milanesas de cuadril cubiertas con salsa de tomate y queso muzarella, acompañadas de arroz, ensalada y papas fritas." },
  ...
  { id: "carnes-comp-04", categoria: "carnes-compartilhar",
    ...
    descricao: { pt: "Filé de frango empanado, coberto com molho de tomate e queijo mussarela, acompanhado de arroz, salada e batata frita.",
                 es: "Milanesas de pollo cubiertas con salsa de tomate y queso muzarella, acompañadas de arroz, ensalada y papas fritas."},
    preco: "129,00", imagem: null },
  ...
  { id: "sanduiches-01", categoria: "sanduiches",
    ...
    descricao: { pt: "Creme de salmão com ricota, molho pesto, folhas de alface e tomate-cereja.",
                 es: "Crema de salmón y ricota, pesto, hojas de lechuga y tomates cherry." },
    preco: "54,00", imagem: null },
  { id: "sanduiches-02", categoria: "sanduiches",
    nome: { pt: "Baguete de Frango" },
    descricao: { pt: "Frango grelhado, molho especial da casa, chimichurri, folhas de alface e tomate seco.",
                 es: "Pollo a la plancha, salsa especial de la casa, chimichurri, hojas de lechuga y tomates secos." },
    preco: "39,00", imagem: null },
  { id: "sanduiches-03", categoria: "sanduiches",
    ...
    descricao: { pt: "Abobrinha grelhada, pesto de manjericão, folhas de rúcula e tomate seco.",
                 es: "Zucchini asado, pesto de albahaca, hojas de rúcula y tomate seco." },
  ...
  { id: "sanduiches-04", categoria: "sanduiches",
    ...
    descricao: { pt: "Clássico sanduíche de pão de forma com presunto e queijo mussarela derretido.",
                 es: "Clásico tostado de jamón y queso muzarella derretida." },
  ...
  { id: "hamburgueres-01", categoria: "hamburgueres",
    ...
    descricao: { pt: "Mini hambúrgueres artesanais com cheddar, alface e tomate, acompanhados de batata frita e molho da casa.",
                 es: "Mini hamburguesas artesanales con queso cheddar, lechuga y tomate, acompañadas con papas fritas y salsa de la casa." },
  ...
  { id: "hamburgueres-02", categoria: "hamburgueres",
    ...
    descricao: { pt: "Hambúrguer artesanal com queijo mussarela derretido, acompanhado de batata frita e molho da casa.",
                 es: "Hamburguesa artesanal con queso muzarella derretido, acompañada con papas fritas y salsa de la casa." },
  ...
  { id: "hamburgueres-03", categoria: "hamburgueres",
    ...
    descricao: { pt: "Hambúrguer artesanal com queijo mussarela, alface e tomate, acompanhado de batata frita e molho da casa.",
                 es: "Hamburguesa artesanal con queso muzarella, lechuga y tomate, acompañada con papas fritas y salsa de la casa." },
    preco: "55,00", imagem: null },
  { id: "hamburgueres-04", categoria: "hamburgueres",
    ...
    descricao: { pt: "Hambúrguer artesanal com queijo mussarela, bacon crocante e cebola caramelizada, acompanhado de batata frita e molho da casa.",
                 es: "Hamburguesa artesanal con queso muzarella, bacon crocante y cebolla caramelizada, acompañada con papas fritas y salsa de la casa." },
    preco: "59,00", imagem: null },
  { id: "hamburgueres-05", categoria: "hamburgueres",
    ...
    descricao: { pt: "Hambúrguer artesanal com queijo cheddar cremoso, acompanhado de batata frita e molho da casa.",
                 es: "Hamburguesa artesanal con queso cheddar cremoso, acompañada con papas fritas y salsa de la casa." },
    preco: "55,00", imagem: null },
  ...
  { id: "sobremesas-01", categoria: "sobremesas",
    ...
    descricao: { pt: "Bolinho de chocolate servido quente, com recheio cremoso de chocolate, acompanhado de sorvete de creme e finalizado com calda de chocolate.",
                 es: "Clásico volcán de chocolate tibio con relleno de chocolate cremoso, acompañado de una bocha de helado de crema y cobertura de chocolate." },
    preco: "39,00", imagem: null },
  { id: "sobremesas-02", categoria: "sobremesas",
    ...
    descricao: { pt: "Brownie de chocolate intenso, com textura macia por dentro e leve crocância por fora, servido com sorvete de creme e calda de chocolate.",
                 es: "Brownie de chocolate intenso, con textura suave por dentro y una sutilmente crocante por fuera, servido con una bocha de helado de crema y cobertura de chocolate." },
    preco: "39,00", imagem: null },

  // ============ ACOMPANHAMENTOS (sem preço no documento) ============
  { id: "acomp-01", categoria: "acompanhamentos", nome: { pt: "Arroz (300g)" }, descricao: { pt: "Porção de arroz branco soltinho.", es: "Porción de arroz blanco." }, preco: "", imagem: null },
  { id: "acomp-02", categoria: "acompanhamentos", nome: { pt: "Feijão (300g)" }, descricao: { pt: "Porção de feijão cremoso.", es: "Porción de porotos cremosos." }, preco: "", imagem: null },
  { id: "acomp-02-2", categoria: "acompanhamentos", nome: { pt: "Ovo (02 Unid.)" }, descricao: { pt: "2 ovos fritos.", es: "2 huevos fritos." }, preco: "", imagem: null },
  { id: "acomp-03", categoria: "acompanhamentos", nome: { pt: "Massa na Manteiga (300g)" }, descricao: { pt: "Porção de macarrões cozidos, finalizado com manteiga.", es: "Porción de fideos con manteca." }, preco: "", imagem: null },
  { id: "acomp-04", categoria: "acompanhamentos", nome: { pt: "Mix de Folhas" }, descricao: { pt: "Salada de folhas verdes.", es: "Ensalada de hojas verdes." }, preco: "" , imagem: null },
  { id: "acomp-05", categoria: "acompanhamentos", nome: { pt: "Farofa (150g)" }, descricao: { pt: "Clássica farofa crocante.", es: "Clásica farofa crocante." }, preco: "" , imagem: null },
  { id: "acomp-06", categoria: "acompanhamentos", nome: { pt: "Purê de Batata (300g)" }, descricao: { pt: "Porção de purê de batata cremoso.", es: "Porción de puré de papa cremoso." }, preco: "", imagem: null },
  { id: "acomp-07", categoria: "acompanhamentos", nome: { pt: "Purê de Abóbora (300g)" }, descricao: { pt: "Porção de purê de abóbora.", es: "Porción de puré de calabaza." }, preco: "", imagem: null },
  { id: "acomp-08", categoria: "acompanhamentos", nome: { pt: "Legumes Grelhados na Manteiga (300g)" }, descricao: { pt: "Porção de legumes grelhados na manteiga.", es: "Porción de verduras salteadas en manteca." }, preco: "", imagem: null },
  ...
  // ============ VITAMINAS E SHAKES ============
  { id: "vitaminas-01", categoria: "vitaminas-shakes", 
    nome: { pt: "Vitamina de Banana" },
    descricao: { pt: "Cremosa vitamina de banana com leite integral.", 
                 es: "Cremosos licuado de banana con leche integral." },
    preco: "21,00", imagem: null },
  { id: "vitaminas-02", categoria: "vitaminas-shakes",
    nome: { pt: "Vitamina de Morango" },
    descricao: { pt: "Clássica vitamina de morangos com leite integral.", 
                 es: "Delicioso licuado de frutillas con leche integral." },
    preco: "21,00", imagem: null },
  { id: "vitaminas-03", categoria: "vitaminas-shakes",
    nome: { pt: "Milk Shake Cookies & Cream" },
    descricao: { pt: "Clássico shake de sorvete de creme com pedacinhos de bolacha Oreo.",
                 es: "Clásico batido de helado de crema con pedacitos de galletita Oreo."},
    preco: "39,00", imagem: null },
  { id: "vitaminas-04", categoria: "vitaminas-shakes",
    nome: { pt: "Milk Shake Chocolate Crocante" },
    descricao: { pt: "Shake super cremoso com todo o sabor e a crocância de Ovomaltine.",
                 es: "Batido super cremoso de chocolate malteado crocante." },
    preco: "39,00", imagem: null },
  ...
  { id: "sucos-01", categoria: "sucos",
    ...
    descricao: { pt: "Suco natural de laranjas frescas.",
                 es: "Jugo natural de naranjas frescas."},
  ...
  { id: "sucos-02", categoria: "sucos",
    ...
    descricao: { pt: "Suco natural de laranja com morangos frescos.",
                 es: "Jugo natural de naranja con frutillas frescas." },
    preco: "21,00", imagem: null },
  { id: "sucos-03", categoria: "sucos",
    nome: { pt: "Sucos de Fruta" },
    descricao: { pt: "Morango • Abacaxi • Abacaxi & Hortelã • Maracujá",
                 es: "Frutilla • Ananá • Ananá & Menta • Maracuyá" },
  ...
  { id: "limonadas-01", categoria: "limonadas",
    ...
    descricao: { pt: "A tradicional limonada feita na hora.",
                 es: "Tradicional limoada preparada en el momento." },
    preco: "16,00", imagem: null },
  { id: "limonadas-02", categoria: "limonadas",
    ...
    descricao: { pt: "A clássica limonada com um delicado toque de frutas vermelhas.",
                 es: "La clásica limonada con un delicado toque de frutos rojos." },
  ...
  { id: "limonadas-03", categoria: "limonadas",
    ...
    descricao: { pt: "Refrescante limonada com gengibre e hortelã.",
                 es: "Refrescante limonada con jengibre y menta." },
    preco: "18,00", imagem: null },
  ...
  { id: "detox-01", categoria: "artesanais-detox",
    ...
    descricao: { pt: "A energia do açaí combinada com morangos e sucos naturais de laranja e beterraba.",
                 es: "La energía del açaí combinada con frutillas y jugos naturales de naranja y remolacha." },
  ...
  { id: "detox-02", categoria: "artesanais-detox",
    ...
    descricao: { pt: "A intensidade do cupuaçu equilibrada com abacaxi, água de coco e um toque de maçã verde.",
                 es: "La intensidad del cupuaçu equilibrada con ananá, agua de coco y un toque de manzana verde." },
    preco: "26,00", imagem: null },
  { id: "detox-03", categoria: "artesanais-detox",
    ...
    descricao: { pt: "Sucos naturais de cenoura e laranja combinados com abacaxi, hortelã e cúrcuma.",
                 es: "Jugos naturales de zanahoria y naranja combinados con ananá, menta y cúrcuma." },
    preco: "23,00", imagem: null },
  ...
  { id: "praianos-05", categoria: "coqueteis-praianos",
    ...
    descricao: { pt: "Vodka e licor de pêssego combinados com suco de laranja e um delicado toque de romã.",
                 es: "Vodka y licor de durazno combinados con jugo de naranja y un delicado toque de granadina."},
  ...
  { id: "praianos-06", categoria: "coqueteis-praianos",
    ...
    descricao: { pt: "O clássico cubano de rum, limão, hortelã e um toque de água com gás.",
                 es: "El clásico cubano de ron, limón menta y un toque de agua con gas." },
    preco: "31,00", imagem: null, semAlcool: true },
  { id: "praianos-07", categoria: "coqueteis-praianos",
    ...
    descricao: { pt: "Rum, abacaxi, leite de coco e leite condensado em uma combinação cremosa.",
                 es: "Ron, ananá, leche de coco y leche condensada en una combinación cremosa." },
  ...
  { id: "classicos-01", categoria: "classicos-autorais",
    ...
    descricao: { pt: "Gin, Campari e vermute rosso finalizado com zest de laranja.",
                 es: "Gin, Campari y aperitivo rosso finalizado con un zest de naranja."},
    preco: "39,00", imagem: null },
  { id: "classicos-02", categoria: "classicos-autorais",
    nome: { pt: "Margarita" },
    descricao: { pt: "Tequila, licor de laranja e limão finalizados com borda de sal.",
                 es: "Tequila, licor de naranja y limón finalizados con borde de sal." },
    preco: "42,00", imagem: null },
  { id: "classicos-03", categoria: "classicos-autorais",
    nome: { pt: "Çáçá" },
    descricao: { pt: "Cachaça, suco natural de laranja e Blue Curação finalizado com mirtilos e zest de laranja.",
                 es: "Cachaça, jugo natural de naranja y Blue Curação finalizado con arándanos y un zest de naranja." },
    preco: "31,00", imagem: null, semAlcool: true },
  { id: "classicos-04", categoria: "classicos-autorais",
    ...
    descricao: { pt: "Gin Tônica infusionada à escolha: Limão & Framboesa • Laranja, Manga & Canela • Frutas Silvestres",
                 es: "Gin Tonic infusionado a elección: Limón y Frambuesas • Naranjas, Mango y Canela • Frutos Silvestres" },
    preco: "39,00", imagem: null },
  { id: "classicos-05", categoria: "classicos-autorais",
    ...
    descricao: { pt: "Vodka, suco natural de laranja e morangos com toques de frutos vermelhos e hortelã.",
                 es: "Vodka, jugo natural de naranja y frutillas con toques de frutos rojos y menta." },
    preco: "39,00", imagem: null, semAlcool: true },

  // ============ AÇAÍS ============
  { id: "acais-01", categoria: "acais",
    nome: { pt: "Individual 250ml (2 adicionais)" },
    descricao: { pt: "Delicioso açaí com duas opções de toppings inclusas.", es: "Delicioso açaí con dos opciones de toppings incluidas." }, preco: "38,00", imagem: null },
  { id: "acais-02", categoria: "acais",
    nome: { pt: "Compartilhar 400ml (4 adicionais)" },
    descricao: { pt: "Açaí completo com quatro opções de toppings inclusas.", es: "Açaí completo con cuatro opciones de toppings incluidas." }, preco: "48,00", imagem: null },
  { id: "acais-03", categoria: "acais",
    nome: { pt: "Opções inclusas", es: "Opciones incluidas" },
    descricao: { pt: "Banana • Morango • Leite em pó • Leite condensado", es: "Banana • Frutilla • Leche en polvo • Leche condensada" },
    preco: "", imagem: null },
  { id: "acais-04", categoria: "acais",
    nome: { pt: "Extras" },
    descricao: { pt: "Abacaxi • Kiwi • Mirtilo • Ovomaltine • Oreo • Granola • Mel • Paçoca", es: "Ananá • Kiwi • Arándanos • Ovomaltine • Oreo • Granola • Miel • Paçoca" },
